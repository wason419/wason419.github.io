 ...
 * @LastEditors: wason
 * @LastEditTime: 2024-08-29 17:09:19
-->
# 联系方式
...
*技术&业务成果：*     
    ...
    - 开发【用户登录/动态角色权限/数据字典等核心功能】，实现跨项目应用。  
...
*技术&业务成果：*   
    - 项目PC端由【vue3+ts】开发，小程序端由【微信原生】开发实现     
    - 已合作多年，每年视具体情况开展为期2-3月的 全国乡村信息更新采集行动，同步相关数据资源    
    - 及时响应，按要求迭代最新采集需求与界面样式，同步优化一线人员采集体验。    
...
*技术&业务成果：*     
    ...
    - 通过【IndexedDB、Node.js 和 Electron框架】，打包生成 本地化高数据量存储化的桌面应用程序软件，提升用户操作体验。
